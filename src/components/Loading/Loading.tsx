...
export function Ghost() {
  return (
    <div className={styles.Ghost}>
      <div className={[styles.Title, styles.Wave].join(' ')} style={{ animationDelay: '0.2s' }} />
      <div className={[styles.Subtitle, styles.Wave].join(' ')} style={{ animationDelay: '0.3s' }} />
      <div className={styles.Header}>
        <div className={styles.Wave} style={{ animationDelay: '0.4s' }} />
      </div>
      <div className={styles.Paragraph}>
        <span className={styles.Wave} style={{ animationDelay: '0s' }} />
